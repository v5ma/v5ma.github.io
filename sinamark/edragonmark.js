                ...
                "content": `
                    <div>
                      <div className="video-container">
                        <iframe
                          src="https://www.youtube.com/embed/S_nZr3vr4ds?si=740dNtF3UbI3-CaF"
                          frameBorder="0"
                      ...
                      <div>
                        <div>
                          <h1>歡迎來到 SINAMARK</h1>
                          <p>
                            SINAMARK 是 100% 可堆肥蠶絲牙線和可生物降解竹炭牙線的供應商，不含任何有害化學添加劑，使用可重複使用和可回收的容器。
                          </p>
                          <h2>為什麼選擇蠶絲牙線？</h2>
                          <p>
                            蠶絲是最早的牙線材料，直到二戰期間塑料被作為更便宜的替代品。雖然蠶絲感覺奢華，但蠶絲牙線並不是一種奢侈的享受。Sinasilk 只使用 100% 天然蠶絲，因為蠶絲是已知最強的天然線材，且 100% 可堆肥，不含有害添加劑。欲了解更多信息，請訪問<a href="#" className="inner-link" data-target="sinasilk">了解更多關於 Sinasilk</a>
                          </p>
                          <h2>為什麼選擇竹炭牙線？</h2>
                          <p>
                            竹子是一種快速生長的草，因此具有可持續性。經過熱解窯焚燒後，竹子變成生物炭，一種富含碳的材料，可以吸收養分或細菌。欲了解更多信息，請訪問<a href="#" className="inner-link" data-target="sinachar">了解更多關於 Sinachar</a>
                          </p>
                          <h2>為什麼選擇 SINAMARK？</h2>
                          <p>
                        ...
                        <a href="#" className="inner-link" data-target="about">了解更多關於我們以及為什麼選擇 SINAMARK 品牌</a>
                      </div>
                    </div>
                `
            },
              ...
              "sinachar": {
                  ...
                  "content": `
                       <div>
                        ...
                        <a href="#" className="inner-link" data-target="checkout"><h2>產品信息請求與 VIP 表單</h2></a>
                      </div>
                  `
              },
              "testimonials": {
