document.addEventListener("DOMContentLoaded", function() {
    ...
    const pageTitles = {
        ...
        "Traditional Chinese": "SINAMARK 卓越龍牌"
    };
        ...
        "English": {
                ...
                "content": `
                    ...
                    <div>
                        <div>
                          ...
                          <p>
                            Silk was the original dental floss, until WWII when plastic was substituted as a cheaper alternative. Although silk feels luxurious, silk dental floss is not a frivolous luxury. Sinasilk uses only 100% natural silk because silk is the strongest natural thread known to man, yet it is 100% compostable, and has no harmful additives. For more information, go to <a href="#" class="inner-link" data-target="sinasilk">Learn more about Sinasilk</a>
                          </p>
                          <h2>Why buy bamboo charcoal floss?</h2>
                          <p>
                            Bamboo is a fast-growing grass, and is therefore sustainable. After being burned in a pyrolysis kiln, bamboo becomes biochar - a carbon rich material that can absorb nutrients or bacteria. For more information, go to <a href="#" class="inner-link" data-target="sinachar">Learn more about Sinachar</a>
                          </p>
            ...
            "about": {
                ...
                "content": `
                    ...
                    <p>
                      In 1915, Tong Bong started SING FAT Oriental Bazaar after the Great 1906 Earthquake in San Francisco. SING FAT’s flagship store became the symbol of San Francisco Chinatown’s rebirth, and the Chinese people’s resolve to remain in the USA after the US government passed the Chinese Exclusion Act of 1882.
                    </p>
                    <p>
                      One century later, facing unprecedented environmental, social, and political challenges; his great grandson Jeffrey Tong conceived and founded SINAMARK as a transformational brand. SINAMARK product(s) are artistic, beautiful, classical (reflecting traditional Chinese culture), environmental, high-quality, recyclable, and useful.
                    </p>
                    <p>
            ...
            "faq": {
                ...
                "content": `
                    ...
                    <div>
                      <h3>Where is SINAMARK manufactured?</h3>
            ...
            "sinachar": {
                ...
                "content": `
                    ...
                    <a href="#" class="inner-link" data-target="checkout"><h2>Product Info Request & VIP form</h2></a>
                `
            },
            "testimonials": {
                "title": "",
         ...
         "Traditional Chinese": {
            "welcome": {
                ...
                <div class="video-container">
                    ...
                    <div>
                    <h1>歡迎來到卓越龍牌(SINAMARK)</h1>
                    <p>
                      卓越龍牌(SINAMARK)是100%可堆肥絲牙線和可生物降解竹炭牙線的供應商，無任何有害化學添加劑，並使用可重複使用和可回收的容器。
                    </p>
                    <h2>為什麼要購買絲牙線？</h2>
                    <p>
                      絲綢是原始的牙線，直到二戰期間塑料被替代為更便宜的選擇。雖然絲綢感覺奢華，但絲牙線並不是一種輕浮的奢侈品。Sinasilk只使用100%天然絲綢，因為絲綢是已知最強的天然線，但它是100%可堆肥的，沒有有害的添加劑。欲了解更多信息，請訪問<a href="#" class="inner-link" data-target="sinasilk">了解更多關於Sinasilk的信息</a>
                    </p>
                    <h2>為什麼要購買竹炭牙線？</h2>
                    <p>
                      竹子是一種生長迅速的草，因此是可持續的。在高溫裂解窯中燃燒後，竹子變成生物炭——一種富含碳的材料，可以吸收營養物或細菌。欲了解更多信息，請訪問<a href="#" class="inner-link" data-target="sinachar">了解更多關於Sinachar的信息</a>
                    </p>
                    <h2>為什麼要從卓越龍牌(SINAMARK)購買？</h2>
                    <p>
                      我們的中文名是“卓越龍牌”，因為卓越不僅僅是外在的質量，它是內在的完美！卓越是我們的核心價值！
                    </p>
                    <h2>支持循環經濟</h2>
                    <p>
                      當我們丟棄時，對任何人來說都永遠不夠！但當我們重複使用時，對每個人來說都足夠！此外，我們留下更小的碳足跡。今天開始一個健康的習慣吧！
                    </p>
                `
            },
            "about": {
                ...
                "content": `
                      <div>
                      <h1>關於卓越龍牌(SINAMARK)</h1>
                      <p>
                        卓越龍牌(SINAMARK)的願景是推動循環經濟，支持擁有超過 5000 年歷史的中國絲綢和竹文化，倡導良好的牙齒健康，並減少進入垃圾填埋場和海洋的塑料廢物。
                      </p>
                      <p>
                        卓越龍牌(SINAMARK)的使命是通過提供高品質的可堆肥產品和可重複使用的容器，為更健康的生活和更健康的地球點燃可重複使用的文藝復興。
                      </p>
                      <h2>我們的歷史 - 從 生發(SING FAT)到卓越龍牌(SINAMARK)</h2>
                      <p>
                        1915年，唐邦在舊金山1906年大地震後創辦了生發(SING FAT)東方百貨公司。生發(SING FAT)的旗艦店成為舊金山唐人街重生的象徵，也是美國政府在 1882 年通過排華法案後，中國人民堅持留在美國的決心。
                      </p>
                      <p>
                        一個世紀後，面對前所未有的環境、社會和政治挑戰，他的曾孫唐益平(Jeffrey Tong)構思並創建了 卓越龍牌(SINAMARK)這一變革品牌。卓越龍牌(SINAMARK)的產品是藝術的、美麗的、經典的(反映傳統中國文化)、環保的、高質量的、可回收的且有用的。
                      </p>
                      <p>
                        卓越龍牌(SINAMARK)的標誌是一個龍鱗，其中文名 卓越龍牌 意味著“卓越的龍標”，這延續了生發(SING FAT)的遺產，其口號是“龍標”。“卓越”被添加到“龍標”中，因為這是我們的核心價值！卓越不僅僅是外在的品質。它是內在的完美，包括肉眼看不見的品質。
                      </p>
                    </div>
                    <div class="image-container">
                        <img src="https://cdn.glitch.com/b524bd7c-2cd3-4f31-8a22-f1e9fa4b5a87/SING%20FAT%20CO.png?v=1715649417837" crossorigin="anonymous" alt="" class="product-image constrained-image" />
            ...
            "checkout": {
                ...
                "content": `
                      ...
                      <h3>替代非牙科用途</h3>
                      <p>
                        由於 卓越龍牌 (SINAMARK) 的使命是促進循環經濟並減少進入垃圾填埋場和海洋的廢物，請不要丟棄未使用的產品。蠶絲比普通縫紉線強得多，所以蠶絲牙線瓶是優越的應急縫紉套件。只需在可重複使用的瓶子中添加一根地毯針。
                      </p>
                    </div>
                `
            },
            ...
            "blog": {
              ...
              "silk100": {
                  ...
                  "content": `
                      ...
                      <h4>產品詳情</h4>
                      <ul>
                          <li><strong>長度：</strong>1卷 x 30米（33碼）（99英尺）。</li>
                          <li><strong>有效去除牙菌斑：</strong>Silk100 比塑料牙線更能有效去除牙菌斑，因為它的編織紋理提供了比塑料更多的表面積。</li>
                          <li><strong>強韌絲滑：</strong>Silk100 絲滑光滑，因為它是 100% 天然絲線——可以說是已知最強的天然纖維。然而，它是 100% 可堆肥的，最短可以在三個月內分解。100% 絲綢感覺更好，所以你會更願意使用牙線，這導致口腔更清潔。</li>
                          <li><strong>健康天然：</strong>Silk100 有淡淡的天然薄荷味，並塗有素食主義的仙人掌蠟以便於使用。不含漂白劑、染料或其他有害添加劑，如聚四氟乙烯（PTFE）或多氟烷基物質（PFAS）。</li>
                          <li><strong>可重複使用和可回收：</strong>Silk100 的高質量玻璃瓶可重複使用、可清洗、緊湊且可回收。透明玻璃設計讓你可以看到何時需要更換牙線。不銹鋼蓋防止生銹。雙蓋保持牙線清潔。</li>
                      </ul>
                      <h4>補充裝</h4>
                      <p>
                          方便的 4 件裝 sinasilk 和 silk100 牙線補充裝。與原產品相同的高質量絲牙線。每卷可使用 3 個月——假設每天 30 厘米（1 英尺）。多包補充裝不包括玻璃瓶分配器。
                      </p>
                      <div class="image-container">
                          <img
                              src="https://cdn.glitch.com/b524bd7c-2cd3-4f31-8a22-f1e9fa4b5a87/refill.JPG?v=1715570338692"
                              crossorigin="anonymous" alt="Silk100 牙線補充裝"
                              class="product-image constrained-image"
                          />
                      </div>
                      <a href="#" class="inner-link" data-target="checkout"><h2>請求訂購表</h2></a>
              ...
              "sinasilk": {
                  ...
                  "content": `
                      ...
                      <ul>
                          <li><strong>長度：</strong>1卷 x 30米（33碼）（99英尺）。</li>
                          <li><strong>有效去除牙菌斑：</strong>Sinasilk 比塑料牙線更能有效去除牙菌斑，因為它的編織紋理提供了比塑料更多的表面積。</li>
                          <li><strong>強韌絲滑：</strong>Sinasilk 絲滑光滑，因為它是 100% 天然絲線——可以說是已知最強的天然纖維。然而，它是 100% 可堆肥的，最短可以在三個月內分解。100% 絲綢感覺更好，所以你會更願意使用牙線，這導致口腔更清潔。</li>
                          <li><strong>健康天然：</strong>Sinasilk 有淡淡的天然薄荷味，並塗有素食主義的仙人掌蠟以便於使用。不含漂白劑、染料或其他有害添加劑，如聚四氟乙烯（PTFE）或多氟烷基物質（PFAS）。</li>
                          <li><strong>可重複使用和可回收：</strong>Sinasilk 的高質量玻璃瓶可重複使用、可清洗、緊湊且可回收。透明玻璃設計讓你可以看到何時需要更換牙線。不銹鋼蓋防止生銹。雙蓋保持牙線清潔。</li>
                      </ul>
                      <h4>補充裝</h4>
                      <p>
                          方便的 4 件裝 sinasilk 和 silk100 牙線補充裝。與原產品相同的高質量絲牙線。每卷可使用 3 個月——假設每天 30 厘米（1 英尺）。多包補充裝不包括玻璃瓶分配器。
                      ...
                      <div class="image-container">
                          <img
                              src="https://cdn.glitch.com/b524bd7c-2cd3-4f31-8a22-f1e9fa4b5a87/refill.JPG?v=1715570338692"
                              crossorigin="anonymous" alt="Sinasilk 和 Silk100 牙線補充裝相同，只是瓶子不同。"
                              class="product-image constrained-image"
                          />
                      </div>
                      <a href="#" class="inner-link" data-target="checkout"><h2>請求訂購表</h2></a>
              ...
              "sinachar": {
                  ...
                  "content": `
                       <a href="#" class="inner-link" data-target="products">返回產品頁面</a>
                        ...
                        <h4>即將推出：</h4>
                        <p>
                            與絲綢不同，竹子本身不是線。取而代之的是，竹子在有限氧氣的高溫裂解窯中燃燒形成生物炭——一種可以吸附的材料，然後可以注入到線上。生物炭與煤基炭不同，它是生物基的。
                        </p>
                        <p>
                            <strong>問題：</strong>炭是粘性的，而絲是滑的。它們就像陰陽一樣相反，因此一方的好處會抵消另一方的好處。目前沒有一種線可以注入竹炭且可堆肥。今天市場上的每個品牌都使用塑化玉米澱粉（聚乳酸），其強度顯著低於絲綢；或者他們使用石油基的尼龍或聚酯，這些都完全不可生物降解！
                        </p>
                        <p>
                            卓越龍牌 (SINAMARK) 正在與一家公司討論，為首款可在 4 年內生物降解而不成為有毒微塑料的聚酯纖維開創先河。
                        </p>
                        <p>
                            要加入我們的 VIP 名單並獲取 Sinachar 的早期新聞，請留下您的姓名、電子郵件地址，並在“產品？問題？”字段中輸入 VIP。我們不會將您的電子郵件分享或出售給外部方。您可以隨時退出。
                        </p>
                        <a href="#" class="inner-link" data-target="checkout"><h2>產品信息請求和 VIP 表格</h2></a>
