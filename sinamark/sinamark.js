        ...
        "English": {
          "welcome": {
            ...
            allowfullscreen></iframe>
                    <h2>Welcome</h2>
                    <p>SINAMARK (Excellent Dragon Mark) is the purveyor of 100% natural, 100% compostable, 100% silk dental floss (sinasilk); and biodegradable bamboo charcoal dental floss (sinachar).</p>
                    <p><strong>Start a Healthy Habit - Floss with Sinasilk and Sinachar!</strong></p>
                    <h2>Why Choose SINAMARK Products?</h2>
                    <ul>
                        <li>100% natural, compostable, and biodegradable dental floss</li>
                        <li>Reusable and recyclable glass bottles with stainless steel lids</li>
                        <li>Preserving 5000+ years of Chinese silk & bamboo culture</li>
                        <li>Supporting farmers and traditional ways of life in China</li>
                        <li>Reducing plastic waste for a healthier planet</li>
                    </ul>
        ...
        "Traditional Chinese": {
            "welcome": {
                ...
                "content": `
                    ...
                    allowfullscreen></iframe>
                    <h2>歡迎</h2>
                    <p>SINAMARK（卓越龍標）是100%天然、100%可堆肥、100%絲綢牙線（sinasilk）以及可生物降解的竹炭牙線（sinachar）的供應商。</p>
                    <p><strong>開始一個健康的習慣 - 使用Sinasilk和Sinachar牙線！</strong></p>
                    <h2>為什麼選擇SINAMARK產品？</h2>
                    <ul>
                        <li>100%天然、可堆肥和可生物降解的牙線</li>
                        <li>可重複使用和可回收的玻璃瓶與不銹鋼蓋</li>
                        <li>保存超過5000年的中國絲綢與竹文化</li>
                        <li>支持中國農民和傳統生活方式</li>
                        <li>減少塑料廢物，為地球帶來更健康的環境</li>
                    </ul>
            ...
            "about": {
                ...
                "content": `
                    <h2>我們的願景</h2>
                    <p>SINAMARK 的願景是促進循環經濟，分享和保護5000多年的中國絲綢和竹文化，倡導良好的口腔健康，並減少進入堆填區和海洋的塑料廢物。</p>
                    <h2>介紹</h2>
                    <p>在 SINAMARK，我們相信推廣循環經濟，分享和保護中國豐富的絲綢和竹文化，倡導良好的口腔健康，並減少進入堆填區和海洋的塑料廢物。我們的使命是通過提供質量優良的可堆肥產品和可重複使用的容器來激發可重複使用的復興，以實現更健康的生活和更健康的地球。</p>
                    <h2>我們的使命</h2>
                    <p>SINAMARK 的使命是通過提供質量優良的可堆肥產品和可重複使用的容器來激發可重複使用的復興，以實現更健康的生活和更健康的地球。</p>
                    <h2>我們的承諾</h2>
                    <ul>
                        <li>致力於口腔健康</li>
                        <li>致力於提供卓越的口腔護理產品</li>
                        <li>支持中國農民</li>
                        <li>保護絲綢和竹農民的傳統生活方式</li>
                    </ul>
                    <h2>我們的故事</h2>
                    <p>Sinasilk 和 Sinachar 代表著5000多年的絲綢和生物炭製造。</p>
                    <ul>
                        <li>絲質牙線的好處簡要概述-人類已知最強的天然線，但完全可堆肥。</li>
                        <li>竹生物炭牙線的好處簡要概述-像海綿一樣起作用。</li>
                    </ul>
                    <h2>里程碑和成就</h2>
                    <p>在此包括顯著的里程碑和成就。</p>
                    <h2>見證</h2>
                    <blockquote>
                        <p>James S. 5.0 颗星，牙科學生推薦！</p>
                        <p>我是一名現任牙科學生，有人建議我試試這種牙線！總的來說，我對這個產品印象非常深刻！它的質地非常適合使用牙線，可以輕鬆地在我牙齒之間的狹窄空間中穿行，而不會像許多傳統的牙線一樣撕裂-這是我遇到的一個常見問題。</p>
                        <p>在過去的幾年裡，我一直依賴 Oral-B Glide，這款產品效果很好，使用起來也很舒適。但是，Oral-B 包含許多與健康有關的 PFAS！雖然這些風險的程度以及化學物質的數量是否微不足道仍有爭議，但為什麼不安全一點，選擇 SINAMARK 的產品呢？此外，它還具有可生物降解的附加好處，這對環保者來說是一個加分！</p>
                        <p>這種牙線與我的以前使用的牙線一樣有效，非常愉快和舒適。而且，這個產品的用量確實很大！瓶子裡“繭”裡繞著大量的牙線不僅看起來很酷，而且我發現它比我的以前的牙線使用時間更長。裡面捲繞著大量的牙線！非常推薦的產品！</p>
                    </blockquote>
                    <blockquote>
                        <p>Linda. 5.0 颗星，使用後感覺清潔</p>
                        <p>我想試試其他的牙線，因為我的牙醫給了我使用的牙線，它的效果很好，但這種牙線在我的牙齒上有一種柔和的感覺。即使我的牙齒之間緊密排列，它也不像較厚的牙線一樣會破皮。包裝簡單而可堆肥。很高興有機會嘗試絲質牙線，一種天然纖維。</p>
                    </blockquote>
                    <blockquote>
                        <p>J. Takahashi. 5.0 颗星，玻璃瓶裝的牙線很棒，不是塑料！</p>
                        <p>我真的很喜歡這款牙線。也喜歡它是玻璃瓶裝的！</p>
                    </blockquote>
                    <blockquote>
                        <p>Nicholas G. 5.0 颗星，非常好用且環保！:)</p>
                        <p>我真的很喜歡這個牙線，它很好用，沒有塑料廢物，所以對環境很友好！整體來說是一個很棒的產品，謝謝！</p>
                    </blockquote>
                    <blockquote>
                        <p>G.F. Carerra. 5.0 颗星，環保且適合使用的牙線。</p>
                        <p>使用起來很方便。這是我到目前為止嘗試過的最好的。</p>
                    </blockquote>
                    <blockquote>
                        <p>匿名。5.0 颗星，環保且適合使用的牙線。</p>
                        <p>我喜歡它對我的牙齦是安全的，對環境有益。它的質地很舒服，不會刺激牙齦。它做得非常好。</p>
                    </blockquote>
                    <blockquote>
                        <p>亞馬遜客戶</p>
                        <p>這款牙線很好用。我喜歡它可以堆肥！</p>
                    </blockquote>
                    <blockquote>
                        <p>Byron G. 5.0 颗星，很棒的牙線。</p>
                        <p>對我的牙齒非常有效。我有牙橋和緊密排列的牙齒，這種牙線比其他類型的牙線更有效。交貨速度很快。</p>
                    </blockquote>
                `
            },
            "products": {
