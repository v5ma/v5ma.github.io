...
See example of XR Hide Sky (and) Ground (in) AR Mode with your Meta Quest 3:
...
If the mode was VR it removes the vr-mode class from the body, and resets the currentMode to null.
