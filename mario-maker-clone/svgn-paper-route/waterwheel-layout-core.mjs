...
export function build(T,{groundOnly=false}={}){
 ...
 const roadBoxes=[12,27,42,63,78,96,117,138,157,178,206,238];
 ...
 const gp={version:1,adventure:2,index:1,style:'canal',ground,groundStart:true,quota:0,stages:0,minTransfers:0,requiredGrapples:0,bonusPerRail:100,finishOnly:true,
  sections:REGIONS.map(x=>({...x})),cast:[
   ...
   {id:'milo',name:'Milo',x:92,y:60,text:'The express runway is optional. The promenade continues below every sky section.'},
   {id:'fern',name:'Fern',x:175,y:60,text:'The wheelhouse is ahead. These new sky connections are still under route testing.'},
  ...
  waterwheel:{revision:REVISION,preview:true,groundOnly,plannedRecordID:RECORD_ID,landmark:{x:7930,y:1880,radius:190},transfers:TRANSFERS.map(x=>({...x}))}};
