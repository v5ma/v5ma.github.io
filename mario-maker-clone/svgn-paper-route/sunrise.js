...
hook('render',old=>function(...args){
 ...
 const reading=!document.getElementById('prism-panel')?.open&&mode==='play'&&!won&&__delivery.state.view==='3d'&&__delivery.paused&&!!document.querySelector('#sc-journal[open],#flight-deck[open],#flight-deck-guide[open],#score-dialog[open],#bathhouse-atlas[open]');
