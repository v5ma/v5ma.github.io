...
const SIGNS=[
 ...
 [3040,1950,'EXPRESS RUNWAY','JUMP TO TRY / ROAD TO CONTINUE'],
 [4340,1930,'CANAL COLLECTOR','LOW LINE RETURNS TO THE ROAD'],
...
export function populate({course,root,metal,far,sign}){
 ...
 for(const [sx,sy,title,detail]of SIGNS){const s=sign(title+'\n'+detail,sx,-sy,-74,230,62);if(s){s.name='Waterwheel wayfinding: '+title;s.userData.waterwheelCue=true;}}
