...
FILES=['index.html','release.json','release-status.js','sw.js','bathhouse.js','bathhouse.css','portal-network-core.mjs','portal-network.js','cloudview-assets.js','cloudview-world.js','cloudview-ui.js','rider-motion-core.mjs','rider-motion.js','flight-deck.js','xr-input-core.mjs','xr-play.js','xr-webgl-compat.mjs','soundtrack.js','sensory-core.mjs','sensory.js','sensory.css','water-audio.mjs','delivery-upgrade.js','waterwheel-layout-core.mjs','waterwheel-fork-core.mjs','waterwheel-preview.js','waterwheel-preview-art.mjs','waterwheel-preview.css','xr-overlay.mjs']
...
out=Path(os.getenv('ARTIFACT_DIR','/tmp/sky-cycle-waterwheel-public'));out.mkdir(parents=True,exist_ok=True)
...
try:
 for attempt in range(60):
  ...
  for name in FILES:
   try:
    req=urllib.request.Request(url+name+'?verify='+str(time.time_ns()),headers={'Cache-Control':'no-cache','User-Agent':'Sky-Cycle-waterwheel-check'})
