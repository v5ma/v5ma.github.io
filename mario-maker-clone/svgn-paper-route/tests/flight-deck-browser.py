...
try:
 with sync_playwright() as pw:
    ...
    def down(i):
        page.evaluate('(i)=>{testPad.buttons[i].pressed=true;testPad.buttons[i].value=1;}',i);page.wait_for_timeout(120)
    def up(i):
        page.evaluate('(i)=>{testPad.buttons[i].pressed=false;testPad.buttons[i].value=0;}',i);page.wait_for_timeout(120)
    ...
    up(0);before=page.evaluate('player.x');down(15);page.wait_for_timeout(450);up(15)
    ...
    down(15);page.evaluate('testPad.connected=false');page.wait_for_timeout(200)
