...
window.CloudHUD=(()=>{
 ...
 function boot(){
  ...
  // The 3D world updates these instruments only while rendering in 3D.
  // On the shared 2D render path, release stale 3D HUD ownership as well.
  const render=window.render;
  window.render=function(...args){const result=render.apply(this,args);if(window.__delivery?.state.view!=='3d')update();return result;};
