...
(function(){'use strict';
 const VERSION='0.29.0',BUILD='sky-cycle-currentworks-2026.09.22';
 ...
 function boot(){
  ...
  import('./rider-motion.js').then(()=>import('./sky-relay.js')).then(()=>import('./sunrise.js')).then(()=>import('./bathhouse.js')).then(()=>import('./waterwheel-preview.js')).then(()=>{
   ...
   import('./flight-deck.js').then(()=>import('./route-compass.js')).then(()=>import('./sensory.js').catch(error=>console.error('Optional comfort settings could not load:',error))).then(()=>import('./xr-play.js')).then(()=>import('./route-entry.js').catch(error=>console.error('Route mode choices could not load:',error)).then(()=>import('./currentworks-environment.mjs').catch(error=>console.error('Optional Currentworks scenery could not load:',error)))).catch(error=>console.error('Flight Deck or Route Compass could not load:',error));
  });
 }
