...
(function(){'use strict';
 const VERSION='0.23.0',BUILD='sky-cycle-waterwheel-2026.09.15';
 ...
 function boot(){
  ...
  import('./rider-motion.js').then(()=>import('./sky-relay.js')).then(()=>import('./sunrise.js')).then(()=>import('./bathhouse.js')).then(()=>import('./waterwheel.js')).then(()=>{
