...
export function fire(s,direction){const p=s.player;if(s.status!=='playing'||p.reload||p.shotCD||p.craft||p.healing||p.melee)return false;if(!p.mag){hint(s,'Empty. Reload or find ammunition.');return false;}
