...
export function createFreightCutArt(scene,A,chapter){
 ...
 // Thin suspension lines explain the low sorting screen's crawl clearance.
 for(const z of [-12.2,-23.8]){const wire=A.mesh('box',[.025,4.25,.025],0x65736b,'metal');wire.position.set(17.8,3.175,z);scene.add(wire);}
 const labels=[];
 ...
 const marks=[[-5.2,.045,-14.2,0],[-4.4,.045,-18.6,-1.2],[0,.045,-18.7,-1.57],[4.5,.045,-18.5,-1.4],[8.8,.045,-17,-.6]];
 A.label('SPINDLE / OPEN FLOOR\nWEST / LOADING RETURN',16.9,1.3,-23.1,2.2,.5,'#334e49','#f0dab1');
