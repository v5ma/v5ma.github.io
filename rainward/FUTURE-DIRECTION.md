...
Current completed checkpoint: Currentworks Living Garden is verified live at source 0dbfb7a99bcd8d10e4478aa864cde1cb1a573a8a, with runtime integration in 16a3e092f2a94314428e3e52e623f03f29958f22. Read CURRENTWORKS.md and evidence/currentworks-20260922/delivery-verification.json first. The Reclaimed Places e361025 checkpoint and earlier proposed Conservatory work below are historical; the final section records the implemented garden and remaining failed replay.
...
## Completed Currentworks delivery recovery, September 23 UTC

The interrupted library upgrade is already on master and verified at the public site. Do not recreate it or replace Rainward with another game. Choose The Drowned Conservatory - LIVING GARDEN. The delivered runtime build remains rainward-currentworks-garden-20260922, version 0.16.4. Exact Water 0.1.0 and Trees 0.1.3 copies are pinned in vendor/currentworks/source-lock.json and use Rainward's existing Three r177 renderer. Three shallow pools receive waves/depth shading/visual wakes, and five seeded alder/willow trees replace the former cards at existing planters. The existing catalogue task now releases the north archive maintenance return. The original shallow-water traversal, sluice puzzle, lens/core, task rewards, seven chapters and saves remain.

All 482 hosted model/source tests passed and were independently replayed locally. The upgraded Conservatory browser mission passed 25 checks, including full extraction and checkpoint reload with original enemies alive and no forced kills. It uses ordinary Classic keyboard/menu input and finite scavenged resources, not actor/progress assignments. All four Currentworks XR rendering-mode jobs and the five inherited controller/hand menu jobs completed successfully. Synthetic tracking and WebGL captures do not constitute physical Quest/Xbox, real passthrough, comfort or performance acceptance.

Publication run 35807625946 at source 0dbfb7a succeeded. The downloaded archive SHA-256 is 8e321484d3b5e32bdb97c60a85bdda6bbf07c0aed385da7ca24260a274f6a1c4. All 199 receipt paths returned HTTP 200 and match both the manifest and the downloaded exact source. Currentworks source, startup preparation, scene integration and all four pinned upstream files are included. Six later commits through master 8174b7e change no Rainward files. This completion checkpoint updates documentation/evidence only; it does not silently change the tested runtime or claim subsequent documentation was served before checking.

One separate Floodgate regression remains failed: run 35807625914, job 107012225416, artifact 10729326217. The survivor died in the original freight aisle before the smoke action completed, with one smoke and no medkits; no script or graphics errors were captured. Do not call the entire workflow green, erase that evidence, grant resources or remove enemies to force a pass. The new environment adapter is inactive in Floodgate. Retain the earlier failed garden north-approach trace as well as the improved, finite-supply successful route.

Next bounded work is to diagnose the Floodgate replay's resource/timing reliability and collect actual Quest feedback for garden arrival, water, paused/toggled effects and the archive return. Preserve the Currentworks/legacy graphics switch, Reduced Graphics Light budget and Reduced Motion behaviour. Do not add Fire, Toon or Cloudlets by name alone or change the praised character style. Interior acoustics, stronger enemy tactics, weapon handling, additional contact animation and remaining chapter redesigns are still separate work. Continue recording exact commits, changed paths, real test outcomes and unresolved failures here and in linked receipts during each pass.
