...
export const FLOODGATE_NOTES=Object.freeze([
 ...
 {id:'freight-manifest',title:'The north loading door',author:'Freight crew / last shift',x:16,z:-16,text:'The gate spindle never made it onto the last truck. It is still in the north end of Freight Hall. The south receiver also feeds the west loading shutter. The clinic battery can bring that circuit back. An open shutter offers a retreat into the market, but lookouts can see and follow through it. The north door stays open whether you repair the receiver or not. When you have both components, follow the floodgate signs. Save your strength for the open quay. The fastest route and the safest route are not always the same.'},
