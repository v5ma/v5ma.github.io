...
export const FLOODGATE_NOTES=Object.freeze([
 ...
 {id:'freight-manifest',title:'The north loading door',author:'Freight crew / last shift',x:16,z:-16,text:'The gate spindle never made it onto the last truck. It is still in the north end of Freight Hall. When you have both components, follow the floodgate signs. The marked lever lowers the centre firebreak and opens the east yard door. It is noisy; plan a corner before pulling. The north loading door reconnects that yard to the spindle. Save your strength for the open quay. The fastest route and the safest route are not always the same.'},
