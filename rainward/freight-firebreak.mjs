...
export const FIREBREAK_SCREEN=Object.freeze({id:'freight-firebreak-screen',x:20.5,z:-17.2,w:4,d:.45,h:2.55,bottom:0,kind:'metal',closeOnTask:FIREBREAK_TASK,disabled:true});
...
export const FIREBREAK_LEVER=Object.freeze({id:FIREBREAK_TASK,x:26.1,z:-14.5,title:'Release the freight firebreak / noisy',description:'The linked counterweight lowers the centre partition and opens the east yard door. It breaks the long firing lane but leaves paths around both ends. The mechanism makes noise: plan your next corner before pulling. Save at a shelter to retain the change.',kind:'repair',required:false,customArt:true,reward:{},noiseRadius:18,completeMessage:'Partition down. East yard open. The mechanism carried: turn a corner, do not wait at the lever.'});
export const FIREBREAK_ROUTES=Object.freeze({
 direct:{purpose:'Fast access to supplies and lever; exposed to the Freight lookout along the central aisle.',points:[[21,-5],[21,-11],[24,-14.5],[26.1,-14.5]]},
 north:{purpose:'Longer approach from market/clinic observation to the spindle behind the central firing lane; the quay is still dangerous.',points:[[-22,-10],[-22,-7],[-22,-3.5],[-24,6],[-19,12],[-31,12],[-31,-15],[-27,-24],[-18,-26],[-18,-42],[12,-46],[21,-32],[21,-26.7],[22.3,-26.7]]},
 yard:{purpose:'A changed-world recovery loop, not safety: leave the lowered partition behind, exit east and use a wall corner before returning through the north loading door.',requires:FIREBREAK_TASK,points:[[26.1,-14.5],[30.2,-15],[31,-21],[31,-32],[21,-32],[21,-26.7]]}
});
export function applyFreightFirebreak(level){
 ...
 level.obstacles=level.obstacles.map(o=>o.id==='depot-east'?{...o,z:-23.25,d:13.5}:o).concat([
  {id:'depot-east-south',x:28,z:-11.25,w:1,d:4.5,h:5.5,bottom:0,kind:'brick'},
