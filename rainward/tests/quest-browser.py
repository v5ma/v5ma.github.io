...
with sync_playwright() as pw:
 ...
 try:
  ...
  # Test crafting before drawing patrols; the earlier exposed, interrupted attempts stay archived.
  ...
  wait('!Rainward.state.player.submerged');go(15,23.5);go(3,29);go(0,48);interact();check(p.evaluate('Rainward.state.checkpoint')=='natatorium-lobby','The XR journey saves at the authored dry lobby shelter')
