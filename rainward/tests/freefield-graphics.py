...
with sync_playwright() as pw:
 ...
 try:
  ...
  (OUT/'report.json').write_text(json.dumps({'portal':r,'waist':waist,'errors':errors,'passed':2,'scope':'Rendered GPU shader fixtures only; separate actual-game journeys and physical-headset approval required.'},indent=2))
