...
with sync_playwright() as p:
 ...
 b=p.chromium.launch(**args);c=b.new_context(viewport={'width':1180,'height':780},service_workers='block');c.add_init_script("localStorage.setItem('svgn.rainward.v1.settings',JSON.stringify({controlPreset:'classic',mute:true,low:true,sensitivity:85}))")
