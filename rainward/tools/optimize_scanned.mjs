...
for(const [id,def]of Object.entries(m.models)){
 ...
 await doc.transform(prune(),textureCompress({encoder:sharp,targetFormat:'webp',resize:id==='boulder_01'?[512,512]:[1024,1024],quality:93}));
