...
export function visible(s,e,p=s.player){
 const d=dist(e,p);if(d<1.35)return !obstruction({x:e.x,y:1.5,z:e.z},{x:p.x,y:HEIGHT[p.stance]*.7,z:p.z});
 ...
 if(obstruction({x:e.x,y:1.52,z:e.z},{x:p.x,y:HEIGHT[p.stance]*.72,z:p.z}))return false;
