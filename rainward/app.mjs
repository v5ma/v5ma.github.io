...
let state=createGame(initialChapter),scene=null,mode='title',keys=new Set(),controls=null,last=0,eventSeq=0,frame=0,gamepad=new GamepadInput(),pad={};
