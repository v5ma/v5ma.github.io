...
Current release: Field Desk v0.16.1. Focus: M0 foundations and M1 vertical slice. Updated 2026-09-20.
...
- [ ] ACCESS-01 / P0 / partial / Controller-complete gameplay and menus
  ...
  Next: Playtest the saved riding trigger profile and field desk reach with real Quest controllers and hands. Screen-play DOM menus remain a separate migration task.
