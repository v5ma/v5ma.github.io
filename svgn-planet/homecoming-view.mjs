...
export function createHomecomingPlaza(root,courier){
 ...
 arm.rotation.z=distance(s.n,HOST.n)<12?-.7+Math.sin(s.time*3)*.12:.08;label.quaternion.copy(camera.quaternion).premultiply(maya.quaternion.clone().invert());label.visible=distance(s.n,HOST.n)<30;},inspect:()=>({name:'Common Ground',authoredPlaza:true,flags:{...lastFlags},host:[...HOST.n]})};
}
