...
export function createScene(canvas){
 ...
 scene.add(new T.HemisphereLight('#d8edff','#7f8557',1.65));const sun=new T.DirectionalLight('#ffe4b5',2.75);sun.castShadow=true;sun.shadow.mapSize.set(1024,1024);Object.assign(sun.shadow.camera,{left:-27,right:27,top:27,bottom:-27,near:1,far:100});sun.shadow.normalBias=.055;sun.shadow.bias=-.0002;scene.add(sun,sun.target);
 const streetFog=scene.fog,sky=createSky(scene);
