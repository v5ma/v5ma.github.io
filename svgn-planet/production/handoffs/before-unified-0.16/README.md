# Neighborhood Missions: Lantern Ward campaign candidate v0.15.0

The current candidate layers a five-case Night Watch campaign over the Living Portal neighborhood. It preserves delivery work and resident stories while adding rooftop cape traversal, predator stealth, physical XR tool holsters, freeflow-style nonlethal sentry combat, functional-interior investigations, and a route-choice finale. See [lantern/CAMPAIGN.md](lantern/CAMPAIGN.md) and [lantern/NIGHT-WATCH.md](lantern/NIGHT-WATCH.md).
