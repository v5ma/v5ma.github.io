...
async def main():
 report={'source':os.getenv('GITHUB_SHA'),'base':BASE,'checks':[],'errors':[], 'inputOnly':True,'physicalDevicesTested':False,'scope':'Desktop real renderer and synthetic Xbox. Native XR and hardware approval remain separate.'}
