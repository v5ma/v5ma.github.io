...
with sync_playwright() as pw:
 ...
 try:
  ...
  go(p,16,3.8);p.keyboard.press('KeyF');p.wait_for_function('SVGNPlanet.inspect().city.car==="press"');check(True,'The courier gets into the nearby press hatchback')
  ...
  go(p,173,25);go(p,164,25);go(p,144,25);go(p,130,24);p.keyboard.press('KeyF');p.wait_for_function('SVGNPlanet.inspect().city.car==="press"')
