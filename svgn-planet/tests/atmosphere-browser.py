...
async def main():
 ...
 async with async_playwright() as p:
  ...
  try:
   await page.goto(BASE+'?quality=balanced',wait_until='domcontentloaded');await boot();s=await state();assert s['version']=='0.11.0';ok('Starts the existing v0.9 game with real WebGL')
