...
with sync_playwright() as pw:
    ...
    try:
        ...
        for name in ['vendor/aframe-1.8.0.min.js','modules/environment/trees.js','modules/environment/water.js','modules/environment/fire.js','river/core.js','river/art.js','river/bank-trees.js','tests/environment-trees-objects.js']:
