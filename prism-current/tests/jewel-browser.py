"""Matched native renderer review. Normal UI, selected profile and audio time;
...
with sync_playwright() as pw:
 ...
 try:
  ...
  check(p.evaluate('PrismCore.VERSION')=='0.2.0','The original game loads the Jewelbox art release')
