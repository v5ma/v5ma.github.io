...
with sync_playwright() as pw:
    ...
    try:
        ...
        for f in ['vendor/aframe-1.8.0.min.js','modules/environment/water.js','modules/environment/fire.js','river/core.js','river/art.js','tests/environment-fire-objects.js','tests/environment-fire-preparation.js']:
            p.add_script_tag(content=(ROOT/'prism-current'/f).read_text())
        p.evaluate('window.fireAsyncComplete')
