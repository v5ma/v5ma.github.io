...
with sync_playwright() as pw:
    ...
    try:
        ...
        for f in ['vendor/aframe-1.8.0.min.js','modules/environment/water.js','modules/environment/fire.js','river/difficulty.js','river/core.js','river/art.js','tests/environment-fire-objects.js','tests/environment-fire-preparation.js']:
