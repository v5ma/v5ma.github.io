...
with sync_playwright() as pw:
    ...
    try:
        ...
        for f in ['vendor/aframe-1.8.0.min.js','modules/environment/water.js','modules/environment/fire.js','modules/environment/trees.js','modules/environment/toon.js','modules/environment/cloudlets.js','modules/environment/islands.js','modules/environment/grass.js','modules/environment/water-detail.js','modules/environment/water-optics.js','river/difficulty.js','river/core.js','river/art.js','river/bank-trees.js','river/ar-islands.js','tests/ar-tide-objects.js','tests/environment-grass-objects.js']:
