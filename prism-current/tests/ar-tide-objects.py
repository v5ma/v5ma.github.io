...
with sync_playwright() as pw:
    ...
    try:
        ...
        for f in ['vendor/aframe-1.8.0.min.js','modules/environment/water.js','modules/environment/fire.js','modules/environment/trees.js','modules/environment/toon.js','modules/environment/cloudlets.js','modules/environment/islands.js','modules/environment/water-optics.js','river/difficulty.js','river/core.js','river/art.js','river/bank-trees.js','river/ar-islands.js','tests/ar-tide-objects.js']:
            p.add_script_tag(content=(ROOT/'prism-current'/f).read_text())
        r=p.evaluate('window.arTideObjectReport');assert r;(OUT/'objects.json').write_text(json.dumps(r,indent=2));print(json.dumps(r,indent=2))
    finally:b.close()
