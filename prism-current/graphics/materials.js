...
(function(root){'use strict';
 ...
 function create(T){const clock={value:0},pulse={value:0},strength={value:.72},motion={value:1};const owned=[],geometries=[],textures=[],targets=[];
  ...
  const floor=keep(new T.MeshPhysicalMaterial({color:0x172335,metalness:.72,roughness:.21,clearcoat:1,clearcoatRoughness:.13,envMapIntensity:.22}));floor.name='Environment-reflective obsidian';
