...
(function(){'use strict';const $=id=>document.getElementById(id),C=RiverCore,PREF='prism-current.river.settings.v1';
 AFRAME.registerComponent('river-game',{
  init(){this.T=AFRAME.THREE;this.art=RiverArt.build(this.T,this.el);this.audio=new PrismAudio();this.state=null;this.chapter='duck-armada';this.phase='menu';this.immersive=false;this.message='Water + Fire 0.11.3 / Cut fruit. Shoot engines. Grip shields.';this.cruise=false;this.quiet=matchMedia('(prefers-reduced-motion: reduce)').matches;this.quality='balanced';this.serial=0;this.busy=false;this.aim=[0,0];this.playerX=0;this.crouch=0;this.activeHand=0;this.keys=new Set();this.captures=new Map();this.previous=[null,null];this.animations=[null,null];this.shields=[null,null];this.mouse=null;this.mouseFire=false;this.touchFire=false;this.touchShield=false;this.padId=null;this.padOld=[];this.seedPad=true;this.padDir=0;this.repeatAt=0;this.lastTime=0;this.lastFx=0;this.runMode='desktop';this.records={};this.cut=[0,-1];
