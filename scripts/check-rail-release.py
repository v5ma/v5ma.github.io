...
assert status.count("import('./prismatic-renderer.js')")==1,'Material pass must have one independent optional entry'
...
for path in ['rail-editor-acceptance.yml','ride-lab-acceptance.yml','flow-route-review.yml','sky-relay.yml','prismatic.yml']:
...
print('PASS: complete source, single-loaded modules, independent visual layer, private-worker dependencies, read-only CI and matching build metadata')
