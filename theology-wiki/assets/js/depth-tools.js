...
function shell(){
 ...
 strip.innerHTML=link('home','Library')+link('sources-index','Conversations')+link('reading-paths','Reading paths')+'<a class="wiki-family-link" href="./role-workbook.html" id="pattern-workbook-link">Verse rankings &amp; repair</a>'+`<details class="depth-site-menu"><summary>More</summary><div>${link('connections','Connections')}${link('forecast-ledger','Forecast register')}${link('glossary','Glossary')}${link('image-collection','Image credits')}${link('research-method','Editorial method')}<a href="../index.html">All projects</a><a href="./index.html">Legacy reader</a></div></details>`;
