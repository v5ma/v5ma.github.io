---
title: "Parallel timelines and versions"
...
## June comparison: Teacher before Jesus

### An earlier Teacher compared with Jesus

Relative sequence; no absolute date assigned. The source asks about a Teacher roughly 150 years before Jesus, then compares messages and layers of instruction. It does not state the October identity reconstruction in the same form.
...
88 BCE (author premise). The strong identification locates the founder earlier than later biographies. This is a thesis under examination, not an independently demonstrated date.
...
After 70 CE; no endpoint specified. A proposed later literary layer responds to catastrophe. The marker is an open-ended author proposal, not a claim that every Gnostic composition begins here.

## Material witnesses (curatorial dates)

### Aramaic Enoch, 4Q201

Approximately 200-150 BCE. The Library of Congress exhibition dates this manuscript witness to this range. It is not the date of every Enochic work or proof of a later lineage.

### Calendrical document, 4Q321

Approximately 50-25 BCE. The exhibition supplies this manuscript date and discusses a 364-day calendar. A shared calendar is evidence to compare, not an automatic identity between communities.
...
### K.3375: Gilgamesh Tablet XI witness

Seventh century BCE (museum attribution). The coordinate represents the century assigned to a surviving tablet, not the date of the flood or the first composition. The catalogue was accessed through an indexed record.
...
Living-memory claim within the text. The statement that many witnesses remained alive is a constraint requiring explanation in an earlier-founder reconstruction. Community persistence alone does not resolve it.
