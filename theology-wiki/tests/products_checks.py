...
def run_products_checks(page, ctx, open_page, navigate, check, screenshot, OUT, BASE):
    ...
    check('Listening app exposes all 29 complete articles and 17 chapter routes',page.locator('#listen-article option').count()==29 and page.locator('#listen-chapter option').count()==18)
