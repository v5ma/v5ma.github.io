...
with sync_playwright() as tool:
    ...
    try:
        open_page(page)
        check('Native HTTP reader loads 425 indexed pages', page.evaluate('TheologyReader.pages().length') == 425)
