## The proposed cause, not just a new date

The Temple-trauma conjecture asks whether the destruction of the Temple in 70 CE helped change the emotional and conceptual conditions of Jewish-Christian mystical teaching. Could historical catastrophe contribute to more radically rejectionist cosmologies? I compare a Jesus-James trajectory with a Pauline trajectory, then ask whether later traditions move from escape from a damaged world toward its repair.

The explanatory proposal connects a community's historical experience with the character of a text. When a work was written matters, but so does why the world appears hostile, broken, redeemable or capable of restoration within it. The conjecture must be tested against independent chronology; a date generated to fit the emotional arc supplies no independent support.

## Comparing trajectories without flattening them
...
A competing date deserves an explanation of its evidence. I want to know which arguments survive that comparison, which need revision and which proposed connections remain possible. A chronological chart adjusted to produce a desired progression cannot answer those questions.
