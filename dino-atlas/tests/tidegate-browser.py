...
try:
 with sync_playwright() as pw:
  ...
  try:
   ...
   check(page.evaluate('__tidegate.state.build')=='tidegate-20260915.1','Authored Tidegate scene boots with real HTTP and WebGL');snap('01-arrival.png')
