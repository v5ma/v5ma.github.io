...
try:
 with sync_playwright() as pw:
  ...
  try:
   ...
   before=page.evaluate('__dinoEconomy.state.credits');page.evaluate('__dinoRanger.teleport(-44,203)');wait('document.getElementById("interact-label").textContent.includes("Manage Crest")');press(0);wait('document.getElementById("pen-dialog").open')
   page.evaluate('document.getElementById("pen-feed").focus()');press(0);press(1);press(13)
   wait('__dinoRanch.state.task.done===4',240000);press(0);wait('document.getElementById("pen-dialog").open');page.evaluate('document.getElementById("pen-gate").focus()');press(0);press(1)
