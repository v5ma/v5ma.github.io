...
export class FieldNavigation{
 constructor({root,travel,fleet,task,yaw}){
  ...
  this.arrow=document.createElement('span');this.arrow.style.cssText='display:inline-block;border-left:8px solid transparent;border-right:8px solid transparent;border-bottom:16px solid #ffd34d;margin-right:10px';this.text=document.createElement('span');this.hud.append(this.arrow,this.text);(document.querySelector('#hud .objective,#hud .mission')||document.getElementById('hud')).append(this.hud);
