...
import {PENS,OUTPOSTS,TRAILS,WATER,DOCK,CHECKPOINTS,penState,penTerminal,isWater} from './frontier-data.js?v=ops1';
import {seeded,distance,clamp} from './ranger-data.js';
import {material,part,box,ellipsoid,bone,label} from './ranger-art.js';
import {bakeStatics} from './frontier-art.js?v=ops1';
