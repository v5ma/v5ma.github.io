...
export function sanitizeEconomy(v){
 ...
 if(Array.isArray(v.rewardLedger))s.rewardLedger=[...new Set(v.rewardLedger.filter(x=>typeof x==='string'&&(x.startsWith('ranch:')||['aaa:storm-response','aaa:living-herds','aaa:northstar-canopy'].includes(x))))].slice(0,64);
