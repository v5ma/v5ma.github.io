...
with sync_playwright() as p:
 ...
 try:
  ...
  mapgame.goto(BASE+'/leonardos-guild/?quality=low',wait_until='domcontentloaded');mapgame.wait_for_function('window.LeonardoGuild')
  def press(b):
  ...
  check(read()['xr']['spatial']['cameraPitch']>.03,'The ordinary right-stick vertical camera control tilts the game view without moving the box');game.evaluate('__xr.replace(1,true)');frames(4)
