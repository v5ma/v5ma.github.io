...
with sync_playwright() as p:
    ...
    try:
        ...
        if MODE=='nearby':
            ...
            drive(10,24);drive(10,60);drive(17,61,.8);drive(23,60,.6)
            ...
            page.locator('[data-city-tab="circuit"]').click();check(page.locator('.city-lamps .on').count()==1,'The diagram shows the real initial crossed-wire state')
