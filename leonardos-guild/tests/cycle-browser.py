...
with sync_playwright() as p:
 ...
 try:
  ...
  page.locator('#start').click();page.set_viewport_size({'width':390,'height':844});page.keyboard.press('KeyI');page.wait_for_selector('#city-dialog[open]');page.locator('[data-city-tab="roadtest"]').click();page.screenshot(path=str(OUT/'portrait-road-test.png'))
