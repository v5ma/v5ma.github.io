 ...
 function draw(renderer,camera){
  ...
  try{
   ...
   if(mode==='diorama'){
    ...
    worldDraw.matrixAutoUpdate=false;worldDraw.matrix.copy(centeredWorldMatrix(a,prefs.scale*zoom,view.heading?.()??getState().yaw,0));mini.updateWorldMatrix(true,true);
