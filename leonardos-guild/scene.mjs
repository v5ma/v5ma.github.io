...
import {heightAt,headingVector,activeTarget,blocked} from './model.mjs';
export function createScene(canvas,w,s,quality='high'){
 ...
 const bike=bicycle(m),rider=person(m),pressCar=car(m);rider.root.userData.guildControlled=true;scene.add(bike.root,rider.root,pressCar.root);label(pressCar.root,'SVGN',-1.001,.81,0,1.4,.35,-Math.PI/2,'#d59140');label(pressCar.root,'SVGN',1.001,.81,0,1.4,.35,Math.PI/2,'#d59140');
