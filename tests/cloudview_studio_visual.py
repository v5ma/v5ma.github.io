...
OUT=Path('test-output/cloudview-studio');OUT.mkdir(parents=True,exist_ok=True)
...
with sync_playwright() as p:
    ...
    try:
        ...
        check(page.locator('#studio-live-link').get_attribute('href').endswith('/svgn-paper-route/index.html'),'Studio retains a return link to the independent live art')
