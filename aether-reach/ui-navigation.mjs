...
export function createMenuNavigator({root,back,onFocus}){
 ...
 function activate(e){if(e.tagName==='SELECT'){adjust(e,1);return;}if(e.type==='range')return;const form=e.form,dialog=form?.getAttribute('method')?.toLowerCase()==='dialog'?form.closest('dialog'):null;e.click();if(dialog?.open)dialog.close(e.value||'');}
