...
with sync_playwright() as pw:
 ...
 try:
  ...
  for target in [(-10,0),(-16,-6),(-70,-8),(-92,-8)]:drive(target)
  tap(2);p.wait_for_function('AetherReach.snapshot().devices.menu==="expedition-dialog"');check('dispatch-delivered' in snap()['expedition']['flags'],'Real street travel and use delivers the dispatch at Bellwether')
