...
with sync_playwright() as pw:
 ...
 try:
  ...
  p.evaluate('TestXR.useHands()');frames(4);pin(830,633);p.wait_for_function('!AetherReach.snapshot().paused');p.evaluate('TestXR.useControllers();TestXR.devices.rays={}');frames(3)
