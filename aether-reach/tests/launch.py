...
with sync_playwright() as p:
 ...
 try:
  ...
  # Additional games must not fail the Aether preservation check. Each original
  # destination is still required exactly once by the route assertions below.
  check(page.locator('.project').count()>=4,'The public project page retains Aether and the original projects while allowing new games')
