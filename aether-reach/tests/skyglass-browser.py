...
with sync_playwright() as pw:
 ...
 try:
  ...
  walk(3,20);walk(17,20);walk(17,17);look(0,-.08);frames(12)
  ...
  p.evaluate('BlackoutDriver.hold(2,12)');frames(8)
  check(snap()['combat']['rift']['id']=='rift-quay-cover','Holding X on the visible spectral surface manifests the real collision-bearing cover')
  p.screenshot(path=str(OUT/'skyglass-active-rift.png'))
  for x,z in [(17,20),(8,20),(8,26)]:walk(x,z)
  look(.97,-.05);frames(8)
