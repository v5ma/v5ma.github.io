...
lines += ['## Release evidence','v0.8.0 Foundry Finish: PR #116; deployed source 878fc4923226c0fce2b5e7d90042bc2f1cbafc06; publication run 34702682332 matched 78 files.','v0.9.0 Bellwether Blackout: PR #126; source cf1dc621dbc392be99380c7fbe51776b90ead068; publication run 34716842597 succeeded. The full controller journey passed 28 checks.', 'v0.10.0 Aurora Cast: see AURORA-CAST.md, art/characters/manifest.json and Aurora browser review. Require the actual post-merge publication receipt; emulation is not physical hardware or player approval.','']
