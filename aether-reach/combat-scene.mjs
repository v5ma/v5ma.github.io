...
export function combatScene(T,{scene,camera,part,box,label,material,movingPart}){
 ...
 const bots=new Map();
 for(const b of ENEMIES){if(b.humanoid)continue;const g=new T.Group();scene.add(g);const type=b.kind;
