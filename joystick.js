...
const style = "position:fixed;display:block;width:100px;height:100px;left:20px;bottom:20px;background-color:#c8c8c880;z-index:20";
...
function initJoystick() {
    ...
    p.innerHTML = "phones: hold + drag 2 move, stuck? reload";
    d.appendChild(p)
};
var moveData = "";
