...
with sync_playwright() as p:
 ...
 try:
  ...
  check(page.locator('#expedition-mode').input_value()=='pilgrimage' and page.evaluate('Vesperfall.state.world.pilgrimage'),'A fresh homepage launch defaults to the seeded Pilgrimage campaign')
