...
with sync_playwright() as p:
 ...
 try:
  ...
  for route in ['vesperfall/index.html']:
   # Verify this game card without pinning names or links of independent projects.
  ...
  check(page.locator('#expedition-mode').input_value()=='returning-bell' and page.evaluate('Vesperfall.state.world.returningBell'),'A fresh homepage launch defaults to the authored Returning Bell chapter')
