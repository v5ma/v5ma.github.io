...
with sync_playwright() as p:
 ...
 browser=p.chromium.launch(**opts);context=browser.new_context(viewport=({'width':640,'height':480} if MODE in ('expedition','gallery') else {'width':1024,'height':720}),service_workers='block')
