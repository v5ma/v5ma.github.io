...
with sync_playwright() as p:
 ...
 try:
  ...
  page.locator('#next').click();check(page.locator('[data-task]').count()==5,'Next-slice filter isolates onboarding, director, boss, route grammar and integration')
  ...
  # Recover malformed old local edits gracefully.
  ...
  # Gamepad fixture supplies only physical input API values.
