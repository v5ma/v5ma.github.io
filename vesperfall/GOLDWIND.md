...
Goldwind is an explicit physical-bow control preset inside the existing game, not another game, new campaign chapter or claimed reconstruction of In Death's private source. Use the menu's Goldwind physical bow button, or choose Goldwind in Settings / Bow controls. Goldwind is the default for fresh settings; an explicitly saved Classic choice remains respected. Xbox shortcuts, keyboard/touch, and all crossbow controls remain unchanged.
