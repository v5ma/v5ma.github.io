...
(function(root){'use strict';
 ...
 function install(g){
  ...
  function atlas(){if(g.game.pilgrimage&&g.pilgrimageView){g.pilgrimageView.atlas();return;}if(g.game.chapter&&g.returningBell){g.returningBell.atlas();return;}const w=g.game.world,canvas=$('map');if(canvas.hidden)return;const ctx=canvas.getContext('2d');
